...
uint8_t V2Horange1[3] = {0x11,0x02,0x01};
uint8_t V2Horange2[3] = {0x0a,0x01,0x02};
//init state aka (Car_H_Green)
uint8_t Hgreen[3] = {0x0C,0x01,0x04};
//init state aka (Car_H2V_Orange)
uint8_t H2Vorange1[3] = {0x0A,0x01,0x02};
uint8_t H2Vorange2[3] = {0x11,0x02,0x01};
...
uint8_t Shownstate[3] = {0x21, 0x0c, 0x11}; // WHAT STATE that is currently being shown

uint8_t indicatorbit = 0x20; // index 1 = pl2 index 2 = pl1

const uint8_t V_Orange_R2G[3] ={0x11, 0x0a, 0x09};
uint8_t V_Green[3] = {0x21, 0x0c, 0x11};
uint8_t V_Orange_G2R[3] = {0x11, 0x0a, 0x11};

uint8_t H_Orange_R2G[3] = {0x0a, 0x09, 0x0a};
uint8_t H_Green[3] = {0x0c, 0x11, 0x0c};
uint8_t H_Orange_G2R[3] = {0x0a, 0x11, 0x0a};
